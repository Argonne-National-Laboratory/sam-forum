#
# Javier Ortensi C110, Idaho National Laboratory
#
# ==============================================================================
# gFHR salt simulation
# ------------------------------------------------------------------------------
# Description:
# gFHR Pebble/TRISO temperature model for equilibrium core calculation
# ==============================================================================
# MODEL PARAMETERS
# ==============================================================================
# Geometry and data.
...
[AuxKernels]
  ...
  [pfuel_power_density]
    ...
    function = 'pebble_power_density * ${fparse pebble_volume / pebble_fuel_volume}'
    args = 'pebble_power_density'
  []
  [kernel_power_density]
    type = ParsedAux
    block = 'kernel'
    variable = kernel_power_density
    function = 'pebble_power_density * ${fparse pebble_volume / triso_number / kernel_volume}'
    args = 'pebble_power_density'
  []
[]
